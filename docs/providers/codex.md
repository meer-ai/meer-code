...
This guide is for people who want to use more than one Codex account in Meer Code.
...
In Meer Code Settings, name it something obvious:
...
In Meer Code Settings, add another Codex provider:
...
Meer Code shows the authenticated email for providers that report one. Emails are blurred by default;
...
If you add a third Codex provider with a completely different `CODEX_HOME path`, Meer Code treats it
