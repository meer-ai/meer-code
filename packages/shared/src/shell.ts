...
const PATH_CAPTURE_START = "__MEER_CODE_PATH_START__";
const PATH_CAPTURE_END = "__MEER_CODE_PATH_END__";
...
function envCaptureStart(name: string): string {
  return `__MEER_CODE_ENV_${name}_START__`;
}

function envCaptureEnd(name: string): string {
  return `__MEER_CODE_ENV_${name}_END__`;
}
