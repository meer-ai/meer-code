...
import { DEFAULT_MEER_MODEL, ProviderOptionSelections } from "./model.ts";
...
export const OpenCodeSettings = makeProviderSettingsSchema(
  {
    ...
    serverUrl: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Server URL",
        description: "Leave blank to let Meer Code spawn the server when needed.",
        providerSettingsForm: {
...
export const MeerSettings = makeProviderSettingsSchema(
  {
    enabled: Schema.Boolean.pipe(
      Schema.withDecodingDefault(Effect.succeed(true)),
      Schema.annotateKey({ providerSettingsForm: { hidden: true } }),
    ),
    binaryPath: makeBinaryPathSetting("meer").pipe(
      Schema.annotateKey({
        title: "Binary path",
        description: "Path to the Meer CLI binary.",
        providerSettingsForm: {
          placeholder: "meer",
          clearWhenEmpty: "omit",
        },
...
export type MeerSettings = typeof MeerSettings.Type;
...
export const ServerSettings = Schema.Struct({
  ...
  providers: Schema.Struct({
    ...
    meer: MeerSettings.pipe(Schema.withDecodingDefault(Effect.succeed({}))),
  }).pipe(Schema.withDecodingDefault(Effect.succeed({}))),
...
const MeerSettingsPatch = Schema.Struct({
  enabled: Schema.optionalKey(Schema.Boolean),
  binaryPath: Schema.optionalKey(TrimmedString),
  customModels: Schema.optionalKey(Schema.Array(Schema.String)),
});
...
export const ServerSettingsPatch = Schema.Struct({
  ...
  providers: Schema.optionalKey(
    Schema.Struct({
      ...
      meer: Schema.optionalKey(MeerSettingsPatch),
    }),
  ),
