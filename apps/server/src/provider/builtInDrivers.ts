 ...
 */
import { MeerDriver, type MeerDriverEnv } from "./Drivers/MeerDriver.ts";
 ...
 */
export type BuiltInDriversEnv = MeerDriverEnv;
 ...
 */
export const BUILT_IN_DRIVERS: ReadonlyArray<AnyProviderDriver<BuiltInDriversEnv>> = [MeerDriver];
