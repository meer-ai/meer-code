 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from "@meer-ai/contracts";
...
>()("meer-code/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
