...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@meer-ai/contracts";
import { VcsUnsupportedOperationError } from "@meer-ai/contracts";
...
export class VcsDriverRegistry extends Context.Service<VcsDriverRegistry, VcsDriverRegistryShape>()(
  "meer-code/vcs/VcsDriverRegistry",
) {}
