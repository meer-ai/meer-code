          ...
          Layer.mergeAll(
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  MEER_CODE_LOG_LEVEL: "Warn",
                  MEER_CODE_MODE: "desktop",
                  MEER_CODE_PORT: "4001",
                  MEER_CODE_HOST: "0.0.0.0",
                  MEER_CODE_HOME: baseDir,
                  VITE_DEV_SERVER_URL: "http://127.0.0.1:5173",
                  MEER_CODE_NO_BROWSER: "true",
                  MEER_CODE_AUTO_BOOTSTRAP_PROJECT_FROM_CWD: "false",
                  MEER_CODE_LOG_WS_EVENTS: "true",
                },
              }),
            ),
            NetService.layer,
            ...
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  ...
                  MEER_CODE_PORT: "4001",
                  MEER_CODE_HOST: "0.0.0.0",
                  MEER_CODE_HOME: join(NodeOS.tmpdir(), "ignored-base"),
                  VITE_DEV_SERVER_URL: "http://127.0.0.1:5173",
                  MEER_CODE_NO_BROWSER: "false",
                  MEER_CODE_AUTO_BOOTSTRAP_PROJECT_FROM_CWD: "false",
                  MEER_CODE_LOG_WS_EVENTS: "false",
                },
              }),
            ),
            NetService.layer,
        ...
        Effect.provide(
          Layer.mergeAll(
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  MEER_CODE_BOOTSTRAP_FD: String(fd),
                  MEER_CODE_NO_BROWSER: "true",
                  MEER_CODE_AUTO_BOOTSTRAP_PROJECT_FROM_CWD: "true",
                  MEER_CODE_LOG_WS_EVENTS: "true",
                },
              }),
            ),
