...
const BitbucketApiEnvConfig = Config.all({
  baseUrl: Config.string("MEER_CODE_BITBUCKET_API_BASE_URL").pipe(
    Config.withDefault(DEFAULT_API_BASE_URL),
  ),
  accessToken: Config.string("MEER_CODE_BITBUCKET_ACCESS_TOKEN").pipe(Config.option),
  email: Config.string("MEER_CODE_BITBUCKET_EMAIL").pipe(Config.option),
  apiToken: Config.string("MEER_CODE_BITBUCKET_API_TOKEN").pipe(Config.option),
});
...
export class BitbucketApi extends Context.Service<BitbucketApi, BitbucketApiShape>()(
  "meer-code/sourceControl/BitbucketApi",
) {}
...
function authFromConfig(
  ...
  return {
    ...
    host: Option.some("bitbucket.org"),
    detail: Option.some(
      "Set MEER_CODE_BITBUCKET_EMAIL and MEER_CODE_BITBUCKET_API_TOKEN, or MEER_CODE_BITBUCKET_ACCESS_TOKEN.",
    ),
  };
}
