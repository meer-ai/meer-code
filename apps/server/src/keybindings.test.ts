import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@meer-ai/contracts";
...
import { KeybindingsConfigError } from "@meer-ai/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "meer-code-keybindings-test-",
        }),
      ),
    ),
  );
