...
import { DEFAULT_MEER_MODEL, ProjectId, ProviderInstanceId, ThreadId } from "@meer-ai/contracts";
...
it("uses the canonical Meer default for auto-bootstrapped model selection", () => {
