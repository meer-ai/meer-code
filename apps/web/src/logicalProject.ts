import { scopedProjectKey, scopeProjectRef } from "@meer-ai/client-runtime";
import type { ScopedProjectRef, SidebarProjectGroupingMode } from "@meer-ai/contracts";
import type { UnifiedSettings } from "@meer-ai/contracts/settings";
