...
function MeerWordmark() {
  return (
    <span className="flex min-w-0 items-center gap-1.5">
      <MeerIcon className="size-4 shrink-0 text-foreground" />
      <span className="truncate text-sm font-semibold text-foreground">Meer</span>
    </span>
  );
}
      ...
      <Tooltip>
        <TooltipTrigger
          render={
            ...
            >
              <MeerWordmark />
              <span className="truncate text-sm font-medium text-muted-foreground">Code</span>
