import { ArchiveIcon, ArchiveX, LoaderIcon, RefreshCwIcon } from "lucide-react";
...
const DEFAULT_DRIVER_KIND = ProviderDriverKind.make("meer");
const MEER_DRIVER_KIND = ProviderDriverKind.make("meer");
  ...
  return (
    <SettingsPageContainer>
      <SettingsSection title="General">
        <SettingsRow
          title="Theme"
          description="Choose how Meer Code looks across the app."
          resetAction={
            theme !== "system" ? (
...
export function ProviderSettingsPanel() {
  ...
  const visibleProviderSettings = PROVIDER_SETTINGS.filter(
    (providerSettings) => providerSettings.provider === MEER_DRIVER_KIND,
  );
  const textGenerationModelSelection = resolveAppModelSelectionState(settings, serverProviders);
  const textGenInstanceId = textGenerationModelSelection.instanceId;
  const lastCheckedAt =
