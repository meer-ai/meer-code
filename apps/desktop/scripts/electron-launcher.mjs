// This file mostly exists because we want dev mode to say "Meer Code (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "Meer Code (Dev)" : "Meer Code";
const APP_BUNDLE_ID = isDevelopment ? "com.meerai.meercode.dev" : "com.meerai.meercode";
