...
const defaultInput = {
  ...
  processArch: "arm64",
  appVersion: "0.0.22",
  appPath: "/Applications/Meer Code.app/Contents/Resources/app.asar",
  isPackaged: false,
  resourcesPath: "/Applications/Meer Code.app/Contents/Resources",
  ...
  it.effect("derives state paths and development identity inside Effect", () =>
    Effect.gen(function* () {
      const environment = yield* makeEnvironment(
        {},
        {
          MEER_CODE_HOME: " /tmp/t3 ",
          MEER_CODE_COMMIT_HASH: " 0123456789abcdef ",
          MEER_CODE_PORT: "4949",
          VITE_DEV_SERVER_URL: "http://localhost:5173",
          MEER_CODE_DEV_REMOTE_T3_SERVER_ENTRY_PATH: " /remote/server.mjs ",
          MEER_CODE_OTLP_TRACES_URL: " http://127.0.0.1:4318/v1/traces ",
          MEER_CODE_OTLP_EXPORT_INTERVAL_MS: "2500",
        },
      );
      ...
      assert.equal(environment.appUserModelId, "com.meerai.meercode.dev");
      assert.equal(environment.linuxWmClass, "meercode-dev");
      assert.deepEqual(
