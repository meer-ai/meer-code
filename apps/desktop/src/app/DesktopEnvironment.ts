...
const makeDesktopEnvironment = Effect.fn("desktop.environment.make")(function* (
  ...
  const baseDir = Option.getOrElse(config.t3Home, () => path.join(homeDirectory, ".meer-code"));
  ...
  const userDataDirName = isDevelopment ? "meercode-dev" : "meercode";
  ...
  return DesktopEnvironment.of({
    ...
    branding,
    displayName,
    appUserModelId: isDevelopment ? "com.meerai.meercode.dev" : "com.meerai.meercode",
    linuxDesktopEntryName: isDevelopment ? "meercode-dev.desktop" : "meercode.desktop",
    linuxWmClass: isDevelopment ? "meercode-dev" : "meercode",
    userDataDirName,
