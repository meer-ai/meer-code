...
import type { DesktopUpdateState } from "@meer-ai/contracts";
    ...
    Layer.provide(
      Layer.mergeAll(
        ...
        DesktopConfig.layerTest({
          MEER_CODE_HOME: `/tmp/t3-desktop-updates-test-${process.pid}`,
          MEER_CODE_DESKTOP_MOCK_UPDATES: "true",
          MEER_CODE_DESKTOP_MOCK_UPDATE_SERVER_PORT: "4141",
          ...options.env,
        }),
      ),
    ),
