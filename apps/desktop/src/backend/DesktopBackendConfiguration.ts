...
const DESKTOP_BACKEND_ENV_NAMES = [
  "MEER_CODE_PORT",
  "MEER_CODE_MODE",
  "MEER_CODE_NO_BROWSER",
  "MEER_CODE_HOST",
  "MEER_CODE_DESKTOP_WS_URL",
  "MEER_CODE_DESKTOP_LAN_ACCESS",
  "MEER_CODE_DESKTOP_LAN_HOST",
  "MEER_CODE_DESKTOP_HTTPS_ENDPOINTS",
  "MEER_CODE_TAILSCALE_SERVE",
  "MEER_CODE_TAILSCALE_SERVE_PORT",
] as const;
