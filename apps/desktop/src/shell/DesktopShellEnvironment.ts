...
>()("@meer-ai/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__MEER_CODE_ENV_${name}_START__`;
const endMarker = (name: string) => `__MEER_CODE_ENV_${name}_END__`;
