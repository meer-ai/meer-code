...
it.layer(NodeServices.layer)("build-desktop-artifact", (it) => {
  ...
  it("switches desktop packaging product names to nightly for nightly builds", () => {
    assert.equal(resolveDesktopProductName("0.0.17"), "Meer Code");
    assert.equal(resolveDesktopProductName("0.0.17-nightly.20260413.42"), "Meer Code (Nightly)");
  });
        ...
        Effect.provide(
          ConfigProvider.layer(
            ConfigProvider.fromEnv({
              env: {
                MEER_CODE_DESKTOP_SKIP_BUILD: "true",
                MEER_CODE_DESKTOP_KEEP_STAGE: "true",
                MEER_CODE_DESKTOP_SIGNED: "true",
                MEER_CODE_DESKTOP_VERBOSE: "true",
                MEER_CODE_DESKTOP_MOCK_UPDATES: "true",
              },
            }),
          ),
        ),
