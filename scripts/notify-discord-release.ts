  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Meer Code prerelease is available for nightly testers."
          : "A new Meer Code latest release is available.",
...
).pipe(Command.withDescription("Post a Meer Code release announcement to Discord."));
