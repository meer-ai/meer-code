...
- `/packages/shared`: Shared runtime utilities consumed by both server and web. Uses explicit subpath exports (e.g. `@meer-ai/shared/git`, `@meer-ai/shared/DrainableWorker`) — no barrel index.
